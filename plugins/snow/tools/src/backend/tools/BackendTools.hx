...
class BackendTools implements tools.spec.BackendTools {
    ...
    public var name(default,null):String = 'snow';
    ...
    public function runUpdate(cwd:String, args:Array<String>):Void {
        ...
        // Update/install snow (and dependencies)
        ...
        if (!libs.exists('snow')) {
            // Snow not available?
            fail('Failed to update or install snow or some of its dependency. Check log.');
        }
